...
// // MtxData<VT, IT> read_proc_local_mtx_data(const char *file_name, const char *seg_method, bool sort_matrix){
// // // MtxData<VT, IT> read_proc_local_mtx_data(file_name, seg_method, config.sort_matrix){
// //     // some func definition
// //     // seg_method = argv[2];
// //     MtxData<VT, IT> mtx;
// // }

// void segmentWork(const MtxData<VT, IT> & mtx, int *workSharingArr, const char * seg_method, int commSize){
//     int segment;
