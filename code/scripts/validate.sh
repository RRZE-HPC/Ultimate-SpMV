...
declare -a Cs=("1" "2" "3" "4" "8" "16" "32" "64" "128" "256")
declare -a sigmas=("1" "2" "3" "4" "8" "16" "32" "64" "128" "256")
...
#             mpirun -n 1 ./../uspmv ../matrices/impcol_e.mtx $kernel_format -mode s $seg_method -rand_x $rand_opt -rev 3 -dp
...
#             mpirun -n 1 ./../uspmv ../matrices/impcol_e.mtx $kernel_format -mode s $seg_method -rand_x $rand_opt -rev 3 -mp
#         done
#     done
# done
...
#             mpirun -n 2 ./../uspmv ../matrices/impcol_e.mtx $kernel_format -mode s $seg_method -rand_x $rand_opt -rev 3 -dp
...
#             mpirun -n 2 ./../uspmv ../matrices/impcol_e.mtx $kernel_format -mode s $seg_method -rand_x $rand_opt -rev 3 -mp
...
#             mpirun -n 4 ./../uspmv ../matrices/impcol_e.mtx $kernel_format -mode s $seg_method -rand_x $rand_opt -rev 3 -dp
...
#             mpirun -n 4 ./../uspmv ../matrices/impcol_e.mtx $kernel_format -mode s $seg_method -rand_x $rand_opt -rev 3 -mp
...
#             mpirun -n 48 ./../uspmv ../matrices/impcol_e.mtx $kernel_format -mode s $seg_method -rand_x $rand_opt -rev 3 -dp
...
#             mpirun -n 48 ./../uspmv ../matrices/impcol_e.mtx $kernel_format -mode s $seg_method -rand_x $rand_opt -rev 3 -mp
#         done
#     done
# done
...
#             mpirun -n 1 ./../uspmv ../matrices/impcol_e.mtx scs -c $C -s 1 -mode s $seg_method -rand_x $rand_opt -rev 3 -dp
...
#             mpirun -n 1 ./../uspmv ../matrices/impcol_e.mtx scs -c $C -s 1 -mode s $seg_method -rand_x $rand_opt -rev 3 -mp
#         done
#     done
# done
...
do
    ...
    do
        ...
        do
            ...
            mpirun -n 2 ./../uspmv ../matrices/impcol_e.mtx scs -c $C -s 1 -mode s $seg_method -rand_x $rand_opt -rev 3 -dp
            ...
            mpirun -n 2 ./../uspmv ../matrices/impcol_e.mtx scs -c $C -s 1 -mode s $seg_method -rand_x $rand_opt -rev 3 -mp
            ...
            mpirun -n 4 ./../uspmv ../matrices/impcol_e.mtx scs -c $C -s 1 -mode s $seg_method -rand_x $rand_opt -rev 3 -dp
            ...
            mpirun -n 4 ./../uspmv ../matrices/impcol_e.mtx scs -c $C -s 1 -mode s $seg_method -rand_x $rand_opt -rev 3 -mp
            ...
            mpirun -n 48 ./../uspmv ../matrices/impcol_e.mtx scs -c $C -s 1 -mode s $seg_method -rand_x $rand_opt -rev 3 -dp
            ...
            mpirun -n 48 ./../uspmv ../matrices/impcol_e.mtx scs -c $C -s 1 -mode s $seg_method -rand_x $rand_opt -rev 3 -mp
...
#             mpirun -n 1 ./../uspmv ../matrices/impcol_e.mtx scs -c 1 -s $sigma -mode s $seg_method -rand_x $rand_opt -rev 3 -dp
...
#             mpirun -n 1 ./../uspmv ../matrices/impcol_e.mtx scs -c 1 -s $sigma -mode s $seg_method -rand_x $rand_opt -rev 3 -mp
#         done
#     done
# done
...
do
    ...
    do
        ...
        do
            ...
            mpirun -n 2 ./../uspmv ../matrices/impcol_e.mtx scs -c 1 -s $sigma -mode s $seg_method -rand_x $rand_opt -rev 3 -dp
            ...
            mpirun -n 2 ./../uspmv ../matrices/impcol_e.mtx scs -c 1 -s $sigma -mode s $seg_method -rand_x $rand_opt -rev 3 -mp
            ...
            mpirun -n 4 ./../uspmv ../matrices/impcol_e.mtx scs -c 1 -s $sigma -mode s $seg_method -rand_x $rand_opt -rev 3 -dp
            ...
            mpirun -n 4 ./../uspmv ../matrices/impcol_e.mtx scs -c 1 -s $sigma -mode s $seg_method -rand_x $rand_opt -rev 3 -mp
            ...
            mpirun -n 48 ./../uspmv ../matrices/impcol_e.mtx scs -c 1 -s $sigma -mode s $seg_method -rand_x $rand_opt -rev 3 -dp
            ...
            mpirun -n 48 ./../uspmv ../matrices/impcol_e.mtx scs -c 1 -s $sigma -mode s $seg_method -rand_x $rand_opt -rev 3 -mp
...
#                     mpirun -n 1 ./../uspmv ../matrices/impcol_e.mtx scs -c $C -s $sigma -mode s $seg_method -rand_x $rand_opt -rev 3 -dp
...
#                     mpirun -n 1 ./../uspmv ../matrices/impcol_e.mtx scs -c $C -s $sigma -mode s $seg_method -rand_x $rand_opt -rev 3 -mp
#                 fi
#             done
#         done
#     done
        ...
        do
            ...
            do
                ...
                then
                    ...
                    mpirun -n 2 ./../uspmv ../matrices/impcol_e.mtx scs -c $C -s $sigma -mode s $seg_method -rand_x $rand_opt -rev 3 -dp
                    ...
                    mpirun -n 2 ./../uspmv ../matrices/impcol_e.mtx scs -c $C -s $sigma -mode s $seg_method -rand_x $rand_opt -rev 3 -mp
                    ...
                    mpirun -n 4 ./../uspmv ../matrices/impcol_e.mtx scs -c $C -s $sigma -mode s $seg_method -rand_x $rand_opt -rev 3 -dp
                    ...
                    mpirun -n 4 ./../uspmv ../matrices/impcol_e.mtx scs -c $C -s $sigma -mode s $seg_method -rand_x $rand_opt -rev 3 -mp
                    ...
                    mpirun -n 48 ./../uspmv ../matrices/impcol_e.mtx scs -c $C -s $sigma -mode s $seg_method -rand_x $rand_opt -rev 3 -dp
                    ...
                    mpirun -n 48 ./../uspmv ../matrices/impcol_e.mtx scs -c $C -s $sigma -mode s $seg_method -rand_x $rand_opt -rev 3 -mp
                fi
            done
        done
    done
    ...
    do
        ...
        do
            ...
            do
                ...
                mpirun -n 72 ./../uspmv ../matrices/FDM-2d-16.mtx scs -c $C -s $sigma -mode s $seg_method -rand_x $rand_opt -rev 3 -mp
                mpirun -n 48 ./../uspmv ../matrices/matrix1.mtx scs -c $C -s $sigma -mode s $seg_method -rand_x $rand_opt -rev 3 -mp
                mpirun -n 72 ./../uspmv ../matrices/impcol_e.mtx scs -c $C -s $sigma -mode s $seg_method -rand_x $rand_opt -rev 3 -mp
            done
        done
    done
done